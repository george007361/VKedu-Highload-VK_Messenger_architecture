...
1. Авторизация пользователей в день: *15 раз*
   > Будем считать, что при посещении сервиса пользователь авторизуется раз в 3 месяца, получает куку и далее использует её. Получается, что в месяц выполяется 76,9 млн. / 3 = 26,6 млн. запросов авторизации или 0,0,85 млн. запросов в сутки
