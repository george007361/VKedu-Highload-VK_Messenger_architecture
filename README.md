...
Итого необходиомо поддержать: 2 * 88 668 = 177 336 RPS с учётом пиковых нагрузок

Необходимое количество ядер: 177 336 / 2 000 = 88 \
Суммарный трафик: 177 336 RPS * (2 + 64 + 64 + 256 + 128 + 40 + 16) байт = 0,1 Гбит / с

Упираемся в CPU. Если взять сервер с 32 CPU, то потребуется: \
 88 / 32 = 4 сервера. \
Однако в случае падения машины, трафик поделится на 3 оставшиеся и нагрузка на CPU будет: \
177 336 * 100% / (2 000 * 32 * 3) = 92 %

Увеличиваем количество серверов на 1 и аналогичными расчётами получаем нагрузку 70% на CPU в случае падения машины.   
...
Итого необходиомо поддержать: 2 * 265 061 RPS = 530 122 RPS с учетом пиковых нагрузок.

Необходимое количество ядер: 530 122 / 2 000 = 264 \
Суммарный трафик: 2 * (1,27 + 0,13 + 6,4) = 15,6 Гбит / с
...
В случае падения машины, трафик поделится на 15 оставшиеся и нагрузка на сеть будет: \
...
Итого необходиомо поддержать: 2 * 278 000 RPS = 556 000 RPS с учетом пиковых нагрузок.

!!!!!!!!!!! Необходимое количество ядер:   556 000 / 2 000 = 280 \
!!!!!!!!!!!!!!! Суммарный трафик: 2 *0,15 + 0,04 + 1,27 + 0,13 + 6,4 + 28,7 + 104,3 + 27,44 + 96,1 = 264,53 Гбит / с

#### Web
Итого необходиомо поддержать 0,29 *  556 000 = 161 240 RPS.

Необходимое количество ядер: 161 240 / 2 000 = 82 \
Суммарный трафик: 2 * 0,29 * (0,15 + 0,04 + 1,27 + 0,13 + 6,4 + 28,7 + 104,3 + 27,44 + 96,1) = 2 * 0,29 * 264,53 = 152 Гбит / с
...
#### Mobile
Итого необходиомо поддержать 0,71 * 556 000 = 394 760 RPS.

Необходимое количество ядер:  394 760 / 2 000 = 200 \
Суммарный трафик: 2 * 0,71 * (0,15 + 0,04 + 1,27 + 0,13 + 6,4 + 28,7 + 104,3 + 27,44 + 96,1) = 2 * 0,71 * 264,53 = 376 Гбит / с
...
В случае падения машины, трафик поделится на 37 оставшиеся и нагрузка на сеть будет: \
...
Необходимо поддержать RPS: 2 * 283 467 = 566 934 RPS с учетом пиковых нагрузок \
...
Необходиомо поддержать 2 * 88 668 RPS = 177 336 с учетом пиков нагрузки.

Трафик: 2 * (2 + 64 + 64 + 256 + 128 + 40 + 16) байт * 88 668 RPS = 0,1 Гбит / с
...
Эффективная работа индексов достигается большим количеством ОЗУ \
Необходиомо поддержать 2 * 8 576 RPS = 17 152 RPS с учетом пиков нагрузки

Трафик: 40 чатов * (2 + 2 + 2) байт * 17 152 RPS = 32.8 Мбит / с
...
Необходимо поддержать: 2 * (158 680 + 16 009 + 1 715 + 80 046) =  512 900 RPS с учётом пиков \
Трафик:  2 * (6,4 + 1,27 + 0,13) = 15,6 Гбит / с  с учетом пиковых нагрузок
